   ...
   <?php ob_start() ?>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4">
              <!-- logo -->
              <div class="logo text-center-sm"> <a href="index.html"><img src="../images/logo.png" alt=""></a></div>
            </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-5 col-xs-6 ">
                    <div class="form-group">
                      ...
                      <input class="form-control" name = "donde" placeholder="city, province, or region">
                    </div>
                  </div>
                  ...
                  <?php foreach($oferta as $value): ?>
                    <div class="item">
                      <div class="row">
                        ...
                        <div class="col-md-11">
                          <h3 class="no-margin-top"><a href="job_details.html" class=""><?php echo $value["vacante"] ?><i class="fa fa-link color-white-mute font-1x"></i></a></h3>
