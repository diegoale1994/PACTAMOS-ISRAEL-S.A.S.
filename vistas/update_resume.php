        ...
        <div class="modal-body">
                 <div class="row">
                     <div class="col-md-12">                         
                      ...
                      <?php foreach($person as $person4): ?>
                          <input type="hidden" name="doc" value="<?php echo $person4["documento"] ?>">
                        <?php endforeach ?>
                        <label>Empresa</label>
      ...
      <form action="../index.php/update_estudies" method="post" >
        <div class="modal-body">
                 <div class="row">
                     <div class="col-md-12">                         
                      <div class="form-group">
                      <?php foreach($person as $person3): ?>
                          <input type="hidden" name="doc" value="<?php echo $person3["documento"] ?>">
                        <?php endforeach ?>
      ...
      <form action="../index.php/update_reference" method="post" >
        <div class="modal-body">
                 <div class="row">
                     <div class="col-md-12">                         
                      <div class="form-group">
                      <?php foreach($person as $person2): ?>
                          <input type="hidden" name="doc" value="<?php echo $person2["documento"] ?>">
                        <?php endforeach ?>
                        <label>Nombre</label>
      ...
      <form action="../index.php/update_skills" method="post" >
        <div class="modal-body">
                 <div class="row">
                     <div class="col-md-12">                         
                      <div class="form-group">
                        <?php foreach($person as $person1): ?>
                          <input type="hidden" name="doc" value="<?php echo $person1["documento"] ?>">
                        <?php endforeach ?>
            ...
            <div class="desc"><br><br>
              <form action="../index.php/update_person" method="POST">
                ...
                <?php foreach($person as $person): ?>
                  <div class="col-md-6">
                    <div class="form-group ">
                      <input type="hidden" name="doc" value="<?php echo $person["documento"] ?>">
